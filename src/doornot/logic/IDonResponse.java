...
public interface IDonResponse {
	...
	public enum ResponseType {
		ADD_SUCCESS, ADD_FAILURE, DEL_SUCCESS, DEL_FAILURE, SEARCH_EMPTY, SEARCH_SUCCESS, EDIT_SUCCESS, EDIT_FAILURE, UNDO_SUCCESS, UNDO_FAILURE, SAVE_SUCCESS, SAVE_FAILURE, HELP, UNKNOWN_COMMAND
	}
